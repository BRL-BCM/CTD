...
require(CTD)
require(huge)
source("graph.diffuseP1Movie.r")
source("multiNode.getNodeRanksMovie.r")
source("singleNode.getNodeRanksMovie.r")
```
...
ranks = multiNode.getNodeRanksMovie(subset.nodes = c("A", "B"), ig, output_filepath = sprintf("%s/images", getwd()), zoomIn = FALSE)
