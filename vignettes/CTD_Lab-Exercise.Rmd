...
![Figure 1. Cartoon of network in manually_build_graph code chunk.](images/probability_diffusion.png){width=350px}
...
diffusionEventMovie*.png files all at once. Starting from the first image,
...
Now, delete all diffusionEventMovie*.png files from your current directory,
