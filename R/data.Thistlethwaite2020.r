...
#' @docType data
#' @format Thistlethwaite2020 - A data frame with 1364 metabolite 
#'                              features as rows and 545 untargeted 
#'                              metabolomics patient samples as columns, 
#'                              alongside 8 metabolite annotations.
